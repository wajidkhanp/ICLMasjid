...
class ZakatViewController: UIViewController, UITextFieldDelegate {
  ...
  @objc func zakatResults() {
    ...
    let alertCon = UIAlertController(title: "Zakat for this Year", message: message, preferredStyle: .alert)
