...
struct GlobalData {
  ...
  static let donationFormsList = ["PayPal paid to 602-237-2666", "VENMO App paid to 602-237-2666", "Donate with GOFundMe", "ZELLE paid to 602-237-2666"]
  static let donationFormsImages = ["paypal", "venmo", "cashAPP", "zelle"]
